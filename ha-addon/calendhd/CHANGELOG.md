...
- Agenda view: an event's end time now sits right next to its title ("Boendestöd Linus – 12:00") instead of floating at the far edge of the row, visually detached on wide screens.
